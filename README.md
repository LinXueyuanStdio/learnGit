# 目录
# 需求
- [需求1:小项目放在github上一般流程如下](https://github.com/LinXueyuanStdio/learnGit#需求1小项目放在github上一般流程如下--back-to-目录)
- [需求2:参与github开源项目提交pull-request](https://github.com/LinXueyuanStdio/learnGit#需求2参与github开源项目提交pull-request--back-to-目录)
- [需求3:撤销与还原commit](https://github.com/LinXueyuanStdio/learnGit#需求3撤销与还原commit--back-to-目录)
- [需求4:`remote origin already exists`](https://github.com/LinXueyuanStdio/learnGit#需求4remote-origin-already-exists---back-to-目录)
- [需求5:`Permission denied (publickey).`](https://github.com/LinXueyuanStdio/learnGit#需求5permission-denied-publickey---back-to-目录)
- [需求6:`failed to push som refs to`](https://github.com/LinXueyuanStdio/learnGit#需求6failed-to-push-som-refs-to---back-to-目录)
- [需求7:`RPC failed`](https://github.com/LinXueyuanStdio/learnGit#需求7rpc-failed---back-to-目录)
- [需求8](https://github.com/LinXueyuanStdio/learnGit#需求8---back-to-目录)
# Git命令
- [套路](https://github.com/LinXueyuanStdio/learnGit#套路---back-to-目录)
- [最基本的命令](https://github.com/LinXueyuanStdio/learnGit#最基本的命令---back-to-目录)
  - [显示信息类命令](https://github.com/LinXueyuanStdio/learnGit#显示信息类命令----back-to-目录)
  - [创建类命令](https://github.com/LinXueyuanStdio/learnGit#创建类命令---back-to-目录)
  - [撤销类命令](https://github.com/LinXueyuanStdio/learnGit#撤销类命令---back-to-目录)
  - [提交类命令](https://github.com/LinXueyuanStdio/learnGit#提交类命令---back-to-目录)
  - [删除类命令](https://github.com/LinXueyuanStdio/learnGit#删除类命令---back-to-目录)
  - [merge类命令](https://github.com/LinXueyuanStdio/learnGit#merge类命令---back-to-目录)
- [Git常用命令](https://github.com/LinXueyuanStdio/learnGit#git-常用命令---back-to-目录)
  - [远程仓库相关命令](https://github.com/LinXueyuanStdio/learnGit#远程仓库相关命令---back-to-目录)
  - [分支(branch)操作相关命令](https://github.com/LinXueyuanStdio/learnGit#分支branch操作相关命令---back-to-目录)
  - [版本(tag)操作相关命令](https://github.com/LinXueyuanStdio/learnGit#版本tag操作相关命令---back-to-目录)
  - [子模块(submodule)相关操作命令](https://github.com/LinXueyuanStdio/learnGit#子模块submodule相关操作命令---back-to-目录)
